...
public class Main extends Application  {
    ...
    public String iconPicker(){
        ...
        iconDict.put(6,"C:\\Users\\eshas\\IdeaProjects\\PL_Project\\src\\main\\resources\\com\\nyzheirwarner\\nyny\\Images\\IMG_3839.jpg");

        return iconDict.get(ran_IC);
    ...
    public void start(Stage primeStage) throws IOException {
        ...
        primeStage.getIcons().add(new Image(iconPicker()));
        primeStage.show();
    }
